    ...
    func makeDummy() {
        self.places = [
            Place(
                ...
                endDate: "24.02.21",
                diaries: [
                    Diary(title: "서울에 도착하다!", date: "24.02.11", weather: "맑음", content: "너무너무 좋다\n또 오고싶다 ^_^", images: [.sample0, .sample1])
                ]
            ),
            Place(
                name: "포항",
                ...
                endDate: "24.03.11",
                diaries: [
                    Diary(title: "포항 살이 시작!", date: "24.03.01", weather: "흐림", content: "애플 아카데미 시작..!", images: [.sample0])
                ]
            ),
            Place(
                name: "경주",
                ...
                endDate: "23.06.11",
                diaries: [
                    Diary(title: "경주 도착하다!", date: "24.06.06", weather: "맑음", content: "너무너무 좋다\n또 오고싶다 ^_^", images: [.sample2, .sample1])
                ]
            ),
            Place(
                name: "도쿄",
                ...
                endDate: "21.02.20",
                diaries: [
                    Diary(title: "첫 해외여행~", date: "24.02.11", weather: "맑음", content: "너무너무 좋다\n또 오고싶다 ^_^", images: [.sample3, .sample1, ._1_1])
                ]
            ),
            Place(
                name: "강릉",
                ...
                endDate: "22.04.05",
                diaries: [
                    Diary(title: "바다 구경한 날", date: "24.04.03", weather: "맑음", content: "너무너무 좋다\n또 오고싶다 ^_^", images: [.sample5, .sample1])
                ]
            ),Place(
                name: "제주도",
                startDate: "23.11.11",
                endDate: "23.11.16",
                diaries: [
                    Diary(title: "제주 좋다~", date: "23.11.11", weather: "맑음", content: "너무너무 좋다\n또 오고싶다 ^_^", images: [.sample0, .sample1])
                ]
            )
        ]
    }
